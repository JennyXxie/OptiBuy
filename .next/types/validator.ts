...
// Validate ../../src/app/api/coupons/search/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/coupons/search">> = Specific
  const handler = {} as typeof import("../../src/app/api/coupons/search/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/test-integration">> = Specific
