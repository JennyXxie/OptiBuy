...
// 🧩 Temporary mock data (replace later with Supabase or Gemini search results)
const mockProducts: Product[] = [
  {
    ...
    prices: { amazon: 89.99, temu: 45.99, shein: 52.99 },
    bestPrice: { platform: "temu", price: 45.99, savings: 44.0 },
    coupon: { code: "TEMU20", discount: 20, type: "percentage" },
  },
  {
    id: "2",
    ...
    prices: { amazon: 129.99, temu: 67.99, shein: 79.99 },
    bestPrice: { platform: "temu", price: 67.99, savings: 62.0 },
  },
  {
    id: "3",
    name: "Portable Phone Charger",
    image:
      "https://images.unsplash.com/photo-1609592807901-5f8a6a0a8f1a?w=300&h=300&fit=crop",
    prices: { amazon: 29.99, temu: 18.99, shein: 22.99 },
    bestPrice: { platform: "temu", price: 18.99, savings: 11.0 },
  },
];
...
export function ProductSearch() {
  ...
  // 🔮 (Future AI/DB integration placeholder)
  // useEffect(() => {
  //   if (searchQuery.trim()) {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Tabs defaultValue="results" className="w-full">
                      ...
                      {Object.entries(selectedProduct.prices).map(
                        ([platform, price]) => (
                          ...
                          >
                            ...
                            {platform ===
                              selectedProduct.bestPrice.platform && (
            ...
            <TabsContent value="history">
              {selectedProduct ? (
                <PriceChart data={[]} productName={selectedProduct.name} />
              ) : (
                <div className="text-center py-12 text-muted-foreground">
